<template>
  <article class="article-card" :class="className">
    <a href="#" class="article-card__link">
      <picture class="article-card__picture">
        <source media="(max-width: 450px)" type="image/webp" :srcset="imgWebpMobile" />
        <source media="(max-width: 450px)" :srcset="imgMobile" />
        <source media="(max-width: 1169px)" type="image/webp" :srcset="imgWebpTablet" />
        <source media="(max-width: 1169px)" :srcset="imgTablet" />
...
defineProps({
  ...
  imgWebpMobile: { type: String, default: '' },
  imgWebpTablet: { type: String, default: '' },

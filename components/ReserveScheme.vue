<template>
  <div class="reserve__scheme">
    <div class="reserve__scheme-container">
      <h4 class="reserve__scheme-title">Схема зала</h4>
      <div class="reserve__scheme-wrapper">
        ...
        >
          ...
          >
            ...
            <path class="scene__table-num" d="M358.041 204L362.943 192.916H356.762V189.723H367.064V191.998L362.035 204H358.041Z" fill="#FFFFFF" />
          ...
          >
            ...
            <rect x="0" y="185" width="95" height="121" fill="transparent" />
          </g>
        </svg>
      </div>
    </div>
